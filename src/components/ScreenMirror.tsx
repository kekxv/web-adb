...
export default function ScreenMirror({ adb, onClose }: ScreenMirrorProps) {
    ...
    return (
        <div 
            className="fixed z-[200] bg-[#0a0a0a] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/10 overflow-hidden flex flex-col transition-all animate-in fade-in zoom-in duration-200"
